...
class FrameworkAgreement(models.Model):
    ...
    _description = 'Long term agreement on product price with a supplie'

    name = fields.Char('Number', readonly=True)
    supplier_id = fields.Many2one('res.partner', 'Supplier',
        related='portfolio_id.supplier_id', readonly=True)
    ...
    available_quantity = fields.Integer(
        ...
        readonly=True, store=True, default=0,
    )
...
class FrameworkAgreementPricelist(models.Model):
    ...
    _description = 'Price list container'
    ...
    framework_agreement_line_ids = fields.One2many(
        ...
        'Price lines', required=True,
    )


class FrameworkAgreementLine(models.Model):
    _name = 'framework.agreement.line'
    _description = 'Price list line of framework agreement\
    ...
    framework_agreement_pricelist_id = fields.Many2one(
        'framework.agreement.pricelist',
        'Price list', required=True,
    )
    quantity = fields.Integer('Quantity', required=True)
    price = fields.Float(
        string='Negociated price', required=True,
